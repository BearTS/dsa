...
int main() {
  ...
  do {
    ...
    cout << "2. Front Deletion" << endl;
    cout << "3. Back Insertion" << endl;
    cout << "4. Back Deletion" << endl;
    cout << "5. Middle Insertion" << endl;
    cout << "6. Middle Deletion" << endl;
    cout << "7. Display" << endl;
    cout << "8. Exit" << endl;
